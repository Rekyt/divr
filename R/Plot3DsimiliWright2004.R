LESPlot3D<-function(yourdata,Xaxis,Yaxis,Zaxis,xlab="X",ylab="Y",zlab="Z",Xticks=NULL,Yticks=NULL,Zticks=NULL,logxyz="",Rotate=110,Flip=25){
...
#    Mx<-nchar(10^Xticks[length(Xticks)])
...
#      My<-nchar(10^Yticks[length(Yticks)])
...
#      Mz<-nchar(10^Zticks[length(Zticks)])
